...
##### OQS_COPY_FROM_PQCLEAN_FRAGMENT_AM_COND_IF_START
  ...
  AM_COND_IF([ENABLE_KEM_ROUND5], [
    ...
    AC_DEFINE(OQS_ENABLE_KEM_round5_r5nd_0kem_2iot, 1, "Define to 1 when Round5-R5ND_0KEM_2iot enabled")
    AC_DEFINE(OQS_ENABLE_KEM_round5_r5nd_1kem_5d, 1, "Define to 1 when Round5-R5ND_1KEM_5d enabled")
    AC_DEFINE(OQS_ENABLE_KEM_round5_r5nd_5kem_0d, 1, "Define to 1 when Round5-R5ND_5KEM_0d enabled")
    AC_DEFINE(OQS_ENABLE_KEM_round5_r5nd_1kem_4longkey, 1, "Define to 1 when Round5-R5ND_1KEM_4longkey enabled")
    ...
    AC_DEFINE(OQS_ENABLE_KEM_round5_r5n1_3ccakem_0smallct, 1, "Define to 1 when Round5-R5N1_3CCAKEM_0smallCT enabled")
    AC_DEFINE(OQS_ENABLE_KEM_round5_r5nd_5ccakem_0d, 1, "Define to 1 when Round5-R5ND_5CCAKEM_0d enabled")
    AC_DEFINE(OQS_ENABLE_KEM_round5_r5nd_3ccakem_0d, 1, "Define to 1 when Round5-R5ND_3CCAKEM_0d enabled")
    AC_DEFINE(OQS_ENABLE_KEM_round5_r5nd_5ccakem_5d, 1, "Define to 1 when Round5-R5ND_5CCAKEM_5d enabled")
    AC_DEFINE(OQS_ENABLE_KEM_round5_r5nd_1ccakem_5d, 1, "Define to 1 when Round5-R5ND_1CCAKEM_5d enabled")
    AC_DEFINE(OQS_ENABLE_KEM_round5_r5nd_1ccakem_0d, 1, "Define to 1 when Round5-R5ND_1CCAKEM_0d enabled")
    AC_DEFINE(OQS_ENABLE_KEM_round5_r5n1_3ccakem_0d, 1, "Define to 1 when Round5-R5N1_3CCAKEM_0d enabled")
    AC_DEFINE(OQS_ENABLE_KEM_round5_r5nd_3ccakem_5d, 1, "Define to 1 when Round5-R5ND_3CCAKEM_5d enabled")
    AC_DEFINE(OQS_ENABLE_KEM_round5_r5n1_5ccakem_0d, 1, "Define to 1 when Round5-R5N1_5CCAKEM_0d enabled")
    AC_DEFINE(OQS_ENABLE_KEM_round5_r5n1_1ccakem_0d, 1, "Define to 1 when Round5-R5N1_1CCAKEM_0d enabled")
  ])
