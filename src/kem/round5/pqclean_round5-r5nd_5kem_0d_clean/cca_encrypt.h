 ...
 * @return __0__ in case of success
 */
inline int PQCLEAN_ROUND5R5ND_5KEM_0D_crypto_encrypt(unsigned char *ct, unsigned long long *ct_len, const unsigned char *m, const unsigned long long m_len, const unsigned char *pk) {
    return PQCLEAN_ROUND5R5ND_5KEM_0D_r5_cca_pke_encrypt(ct, ct_len, m, m_len, pk);
}
 ...
 * @return __0__ in case of success
 */
inline int PQCLEAN_ROUND5R5ND_5KEM_0D_crypto_encrypt_open(unsigned char *m, unsigned long long *m_len, const unsigned char *ct, const unsigned long long ct_len, const unsigned char *sk) {
    return PQCLEAN_ROUND5R5ND_5KEM_0D_r5_cca_pke_decrypt(m, m_len, ct, ct_len, sk);
}
