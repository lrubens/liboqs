 ...
 * @return __0__ in case of success
 */
int PQCLEAN_ROUND5R5ND_5KEM_0D_CLEAN_r5_cca_pke_decrypt(unsigned char *m, unsigned long long *m_len, const unsigned char *ct, const unsigned long long ct_len, const unsigned char *sk);
