 ...
 */
#define PQCLEAN_ROUND5R5N1_5KEM_0D_CLEAN_constant_time_shift_1_left64(out, shift_amount, flag) do { \
        uint64_t tmp; \
        out = 1llu; \
 ...
 * @return 1 << shift_amount
 */
#define PQCLEAN_ROUND5R5N1_5KEM_0D_CLEAN_constant_time_shift_1_left64(out, shift_amount, flag) out = (1llu << (shift_amount))
...
int PQCLEAN_ROUND5R5N1_5KEM_0D_CLEAN_probe_cm_odd(uint64_t *vplus, const uint16_t x) {
    int i;
    uint64_t a, b, c, y, z;
    uint64_t *vminus = vplus + PROBEVEC64;

    // construct the selector
    PQCLEAN_ROUND5R5N1_5KEM_0D_CLEAN_constant_time_shift_1_left64(y, x & 0x3F, 1); // low bits of index
    PQCLEAN_ROUND5R5N1_5KEM_0D_CLEAN_constant_time_shift_1_left64(z, x >> 6, 0); // high bits of index
...
int PQCLEAN_ROUND5R5N1_5KEM_0D_CLEAN_probe_cm_even(uint64_t *vplus, const uint16_t x) {
    int i;
    uint64_t a, b, c, y, z;
    uint64_t *vminus = vplus + PROBEVEC64;
...
int PQCLEAN_ROUND5R5N1_5KEM_0D_CLEAN_probe_cm(uint64_t *v, const uint16_t x) {
    int i;
    uint64_t a, b, c, y, z;
