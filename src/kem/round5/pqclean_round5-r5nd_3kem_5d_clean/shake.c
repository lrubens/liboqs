 ...
 **************************************************/
void PQCLEAN_ROUND5R5ND_3KEM_5D_cshake128(uint8_t *output, size_t outlen,
               const uint8_t *name, size_t namelen,
               const uint8_t *cstm, size_t cstmlen,
               const uint8_t *input, size_t inlen) {
    shake128incctx state;
    PQCLEAN_ROUND5R5ND_3KEM_5D_cshake128_inc_init(&state, name, namelen, cstm, cstmlen);
    PQCLEAN_ROUND5R5ND_3KEM_5D_cshake128_inc_absorb(&state, input, inlen);
    PQCLEAN_ROUND5R5ND_3KEM_5D_cshake128_inc_finalize(&state);
    PQCLEAN_ROUND5R5ND_3KEM_5D_cshake128_inc_squeeze(output, outlen, &state);
}
 ...
 *              - size_t inlen: length of input in bytes
 **************************************************/
void PQCLEAN_ROUND5R5ND_3KEM_5D_cshake256(uint8_t *output, size_t outlen,
               const uint8_t *name, size_t namelen,
               const uint8_t *cstm, size_t cstmlen,
               const uint8_t *input, size_t inlen) {
    shake256incctx state;
    PQCLEAN_ROUND5R5ND_3KEM_5D_cshake256_inc_init(&state, name, namelen, cstm, cstmlen);
    PQCLEAN_ROUND5R5ND_3KEM_5D_cshake256_inc_absorb(&state, input, inlen);
    PQCLEAN_ROUND5R5ND_3KEM_5D_cshake256_inc_finalize(&state);
    PQCLEAN_ROUND5R5ND_3KEM_5D_cshake256_inc_squeeze(output, outlen, &state);
}
...
void PQCLEAN_ROUND5R5ND_3KEM_5D_r5_xof(void *out, size_t out_len,
            const void *in, size_t in_len) {
    #if (PARAMS_KAPPA_BYTES > 16)
...
void PQCLEAN_ROUND5R5ND_3KEM_5D_r5_xof_s_input(r5_xof_ctx_t *ctx,
    ...
    #if (PARAMS_KAPPA_BYTES > 16)
    PQCLEAN_ROUND5R5ND_3KEM_5D_cshake256_inc_init(ctx, (const uint8_t *)"", 0, sstr, sstr_len);
    PQCLEAN_ROUND5R5ND_3KEM_5D_cshake256_inc_absorb(ctx, in, in_len);
    PQCLEAN_ROUND5R5ND_3KEM_5D_cshake256_inc_finalize(ctx);
    #else
    PQCLEAN_ROUND5R5ND_3KEM_5D_cshake128_inc_init(ctx, (const uint8_t *)"", 0, sstr, sstr_len);
    PQCLEAN_ROUND5R5ND_3KEM_5D_cshake128_inc_absorb(ctx, in, in_len);
    PQCLEAN_ROUND5R5ND_3KEM_5D_cshake128_inc_finalize(ctx);
    #endif
}
