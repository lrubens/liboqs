...
void PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_print_sage_u_matrix(const char *var, const uint16_t *matrix, const size_t nr_rows, const size_t nr_columns) {
    ...
    for (i = 0; i < nr_rows; ++i) {
        ...
        PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_print_sage_u_vector(NULL, matrix + i * nr_columns, nr_columns);
    }
    if (nr_rows > 1) {
        printf("\n])");
    } else {
...
void PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_print_sage_u_vector_matrix(const char *var, const uint16_t *matrix, const size_t nr_rows, const size_t nr_columns, const size_t nr_elements) {
    size_t i, j;
    if (nr_elements == 1) {
        PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_print_sage_u_matrix(var, matrix, nr_rows, nr_columns);
    } else if (nr_rows == 1 && nr_columns == 1) {
        PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_print_sage_u_vector(var, matrix, nr_elements);
    } else {
        if (var != NULL) {
        ...
        for (i = 0; i < nr_rows; ++i) {
            ...
            for (j = 0; j < nr_columns; ++j) {
                ...
                PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_print_sage_u_vector(NULL, matrix + (i * nr_columns + j) * nr_elements, nr_elements);
            }
            if (nr_columns > 1 && nr_elements > 1) {
                printf("\n]");
            } else {
...
void PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_print_sage_s_vector(const char *var, const int16_t *poly, const size_t nr_elements) {
    size_t i;
    if (var != NULL) {
        printf("%s[%zu]=", var, nr_elements);
    }
...
void PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_print_sage_s_matrix(const char *var, const int16_t *matrix, const size_t nr_rows, const size_t nr_columns) {
    ...
    for (i = 0; i < nr_rows; ++i) {
        ...
        PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_print_sage_s_vector(NULL, matrix + i * nr_columns, nr_columns);
    }
    if (nr_rows > 1) {
        printf("\n])");
    } else {
...
void PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_print_sage_s_vector_matrix(const char *var, const int16_t *matrix, const size_t nr_rows, const size_t nr_columns, const size_t nr_elements) {
    size_t i, j;
    if (nr_elements == 1) {
        PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_print_sage_s_matrix(var, matrix, nr_rows, nr_columns);
    } else if (nr_rows == 1 && nr_columns == 1) {
        PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_print_sage_s_vector(var, matrix, nr_elements);
    } else {
        if (var != NULL) {
            printf("%s[%zu][%zu][%zu]=", var, nr_rows, nr_columns, nr_elements);
        }
        ...
        for (i = 0; i < nr_rows; ++i) {
            ...
            for (j = 0; j < nr_columns; ++j) {
                ...
                PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_print_sage_s_vector(NULL, matrix + (i * nr_columns + j) * nr_elements, nr_elements);
            }
            if (nr_columns > 1 && nr_elements > 1) {
                printf("\n]");
            } else {
