 ...
 */
inline int PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_crypto_encrypt_keypair(unsigned char *pk, unsigned char *sk) {
    return PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_r5_cca_pke_keygen(pk, sk);
}
