...
void PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_r5_xof(void *out, const size_t out_len,
...
void PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_cshake128(uint8_t *output, size_t outlen, const uint8_t *name, size_t namelen, const uint8_t *cstm, size_t cstmlen, const uint8_t *input, size_t inlen);
...
void PQCLEAN_ROUND5R5N1_3KEM_0D_CLEAN_cshake256(uint8_t *output, size_t outlen, const uint8_t *name, size_t namelen, const uint8_t* cstm, size_t cstmlen, const uint8_t *input, size_t inlen);
