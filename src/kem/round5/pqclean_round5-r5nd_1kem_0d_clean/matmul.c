...
void PQCLEAN_ROUND5R5ND_1KEM_0D_create_secret_matrix_s_t(uint16_t s_t[PARAMS_N_BAR][PARAMS_H / 2][2], const uint8_t *seed) {
    size_t i, l;
    uint16_t x;
    uint8_t v[PARAMS_D];
    r5_xof_ctx_t ctx;
...
void PQCLEAN_ROUND5R5ND_1KEM_0D_create_secret_matrix_r_t(uint16_t r_t[PARAMS_M_BAR][PARAMS_H / 2][2], const uint8_t *seed) {
    size_t i, l;
    uint16_t x;
    uint8_t v[PARAMS_D];
    r5_xof_ctx_t ctx;
...
void PQCLEAN_ROUND5R5ND_1KEM_0D_matmul_as_q(modq_t d[PARAMS_D][PARAMS_N_BAR], modq_t a[PARAMS_D][PARAMS_D], uint16_t s_t[PARAMS_N_BAR][PARAMS_H / 2][2]) {

#elif PARAMS_TAU == 1

void PQCLEAN_ROUND5R5ND_1KEM_0D_matmul_as_q(modq_t d[PARAMS_D][PARAMS_N_BAR], modq_t a[2 * PARAMS_D * PARAMS_D], uint32_t a_permutation[PARAMS_D], uint16_t s_t[PARAMS_N_BAR][PARAMS_H / 2][2]) {

#else

void PQCLEAN_ROUND5R5ND_1KEM_0D_matmul_as_q(modq_t d[PARAMS_D][PARAMS_N_BAR], modq_t a[PARAMS_TAU2_LEN + PARAMS_D], uint16_t a_permutation[PARAMS_D], uint16_t s_t[PARAMS_N_BAR][PARAMS_H / 2][2]) {
...
void PQCLEAN_ROUND5R5ND_1KEM_0D_matmul_rta_q(modq_t d[PARAMS_M_BAR][PARAMS_D], modq_t a[PARAMS_D][PARAMS_D], uint16_t r_t[PARAMS_M_BAR][PARAMS_H / 2][2]) {

#elif PARAMS_TAU == 1

void PQCLEAN_ROUND5R5ND_1KEM_0D_matmul_rta_q(modq_t d[PARAMS_M_BAR][PARAMS_D], modq_t a[2 * PARAMS_D * PARAMS_D], uint32_t a_permutation[PARAMS_D], uint16_t r_t[PARAMS_M_BAR][PARAMS_H / 2][2]) {

#else

void PQCLEAN_ROUND5R5ND_1KEM_0D_matmul_rta_q(modq_t d[PARAMS_M_BAR][PARAMS_D], modq_t a[PARAMS_TAU2_LEN + PARAMS_D], uint16_t a_permutation[PARAMS_D], uint16_t r_t[PARAMS_M_BAR][PARAMS_H / 2][2]) {
...
void PQCLEAN_ROUND5R5ND_1KEM_0D_matmul_stu_p(modp_t d[PARAMS_MU], modp_t u_t[PARAMS_M_BAR][PARAMS_D], uint16_t s_t[PARAMS_N_BAR][PARAMS_H / 2][2]) {
    size_t k, i, j;
...
void PQCLEAN_ROUND5R5ND_1KEM_0D_matmul_btr_p(modp_t d[PARAMS_MU], modp_t b[PARAMS_D][PARAMS_N_BAR], uint16_t r_t[PARAMS_M_BAR][PARAMS_H / 2][2]) {
    size_t i, j, l;
