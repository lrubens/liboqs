 ...
 */
int PQCLEAN_ROUND5R5ND_1KEM_0D_CLEAN_r5_cpa_kem_keygen(unsigned char *pk, unsigned char *sk);
 ...
 * @return __0__ in case of success
 */
int PQCLEAN_ROUND5R5ND_1KEM_0D_CLEAN_r5_cpa_kem_encapsulate(unsigned char *ct, unsigned char *k, const unsigned char *pk);
 ...
 * @return __0__ in case of success
 */
int PQCLEAN_ROUND5R5ND_1KEM_0D_CLEAN_r5_cpa_kem_decapsulate(unsigned char *k, const unsigned char *ct, const unsigned char *sk);
