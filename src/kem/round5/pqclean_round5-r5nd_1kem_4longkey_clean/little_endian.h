 ...
 */
inline uint8_t PQCLEAN_ROUND5R5ND_1KEM_4LONGKEY_CLEAN_u8_from_le(const unsigned char *x) {
    return (uint8_t) x[0];
}
 ...
 */
inline void PQCLEAN_ROUND5R5ND_1KEM_4LONGKEY_CLEAN_u8_to_le(unsigned char *x, const uint8_t u) {
    x[0] = u;
}
 ...
 */
inline uint16_t PQCLEAN_ROUND5R5ND_1KEM_4LONGKEY_CLEAN_u16_from_le(const unsigned char *x) {
    return (uint16_t) (x[0]
                       | (uint16_t) (x[1]) << 8);
}
 ...
 */
inline void PQCLEAN_ROUND5R5ND_1KEM_4LONGKEY_CLEAN_u16_to_le(unsigned char *x, const uint16_t u) {
    x[0] = (unsigned char) u;
 ...
 */
inline uint32_t PQCLEAN_ROUND5R5ND_1KEM_4LONGKEY_CLEAN_u32_from_le(const unsigned char *x) {
    return (uint32_t) (x[0])
           | (((uint32_t) (x[1])) << 8)
           | (((uint32_t) (x[2])) << 16)
           | (((uint32_t) (x[3])) << 24);
 ...
 */
inline void PQCLEAN_ROUND5R5ND_1KEM_4LONGKEY_CLEAN_u32_to_le(unsigned char *x, const uint32_t u) {
    x[0] = (unsigned char) u;
    x[1] = (unsigned char) (u >> 8);
 ...
 */
inline uint64_t PQCLEAN_ROUND5R5ND_1KEM_4LONGKEY_CLEAN_u64_from_le(const unsigned char *x) {
    return (uint64_t) (x[0])
           | (((uint64_t) (x[1])) << 8)
           | (((uint64_t) (x[2])) << 16)
           | (((uint64_t) (x[3])) << 24)
 ...
 */
inline void PQCLEAN_ROUND5R5ND_1KEM_4LONGKEY_CLEAN_u64_to_le(unsigned char *x, const uint64_t u) {
    x[0] = (unsigned char) u;
    x[1] = (unsigned char) (u >> 8);
    x[2] = (unsigned char) (u >> 16);
    x[3] = (unsigned char) (u >> 24);
