...
int PQCLEAN_ROUND5R5N1_3CCAKEM_0SMALLCT_CLEAN_create_A_fixed(const unsigned char *seed) {
    #if PARAMS_TAU == 1
    /* Create A_fixed randomly */
    PQCLEAN_ROUND5R5N1_3CCAKEM_0SMALLCT_CLEAN_create_A_random(A_fixed, seed);
