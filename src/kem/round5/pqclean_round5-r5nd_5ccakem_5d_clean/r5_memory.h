 ...
 */
inline void *PQCLEAN_ROUND5R5ND_5CCAKEM_5D_CLEAN_checked_malloc(size_t size, const char *file, int line) {
 ...
 * @return pointer to the allocated memory
 */
inline void *PQCLEAN_ROUND5R5ND_5CCAKEM_5D_CLEAN_checked_calloc(size_t count, size_t size, const char *file, const int line) {
    (void) file; /* Prevent warning for unused parameter */
    (void) line; /* Prevent warning for unused parameter */
 ...
 */
inline void *PQCLEAN_ROUND5R5ND_5CCAKEM_5D_CLEAN_checked_realloc(void *ptr, size_t size, const char *file, const int line) {
    (void) file; /* Prevent warning for unused parameter */
    (void) line; /* Prevent warning for unused parameter */
 ...
 * @return pointer to the allocated memory
 */
#define PQCLEAN_ROUND5R5ND_5CCAKEM_5D_CLEAN_checked_malloc(size) PQCLEAN_ROUND5R5ND_5CCAKEM_5D_CLEAN_checked_malloc(size, __FILE__, __LINE__)
 ...
 * @return pointer to the allocated memory
 */
#define PQCLEAN_ROUND5R5ND_5CCAKEM_5D_CLEAN_checked_calloc(count, size) PQCLEAN_ROUND5R5ND_5CCAKEM_5D_CLEAN_checked_calloc(count, size, __FILE__, __LINE__)
 ...
 * @return pointer to the reallocated memory
 */
#define PQCLEAN_ROUND5R5ND_5CCAKEM_5D_CLEAN_checked_realloc(ptr, size) PQCLEAN_ROUND5R5ND_5CCAKEM_5D_CLEAN_checked_realloc(ptr, size, __FILE__, __LINE__)
